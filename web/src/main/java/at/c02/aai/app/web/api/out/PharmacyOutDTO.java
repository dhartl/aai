...
public class PharmacyOutDTO implements HasGeoCoordinates {
	private Long id;
	private String name;
	private BigDecimal geoLat;
	private BigDecimal geoLon;

	public PharmacyOutDTO() {
		super();
	}

	public PharmacyOutDTO(Long id, String name, BigDecimal geoLat, BigDecimal geoLon) {
		super();
		this.id = id;
		this.name = name;
		this.geoLat = geoLat;
